...
<xsl:variable name="logo_url">http://8.6.48.250/GoogleTraining/Images/fish.jpg</xsl:variable>
<xsl:variable name="logo_width">151</xsl:variable>
<xsl:variable name="logo_height">74</xsl:variable>
                  ...
                  <form method="get" action="search" name="h">
                    ...
                    <tr bgcolor="{$global_bg_color}">
                      ...
                      <td nowrap="nowrap">
                        ...
                        <input type="hidden" name="getfields" value="last_name" />
                      </td>
                    </tr>
                  </form>
                  </table>
...
<xsl:template match="R">
  ...
  <xsl:if test="$show_res_title != '0'"> 
    ...
    <xsl:choose>
      ...
      <xsl:when test="@MIME='application/pdf'"><img src="http://172.24.24.33/GoogleTraining/Images/pdf.png" alt="pdf" height="30" width="30"></img></xsl:when>
      ...
      <xsl:when test="@MIME='application/msword'"><img src="http://172.24.24.33/GoogleTraining/Images/word.ico" alt="WORD"></img></xsl:when>
      <xsl:otherwise>
  ...
  <xsl:variable name="getfields_author"
    select="MT/@N"/>

  <xsl:if test="$getfields_author = 'last_name'">
    <span class="s">
        <br/>
           <xsl:text>Patient Last Name: </xsl:text><xsl:value-of select="MT[@N='last_name']/@V"/>
    </span>
  </xsl:if>
...
<xsl:template match="C">
    ...
    <xsl:if test="$show_res_cache != '0'">
	  ...
	  <xsl:choose>
        ...
        <a class="f" href="search?q=cache:{$docid}:{$stripped_url}+{
