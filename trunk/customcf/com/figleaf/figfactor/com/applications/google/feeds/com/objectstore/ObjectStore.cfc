...
<cfset variables.STORAGE_PATH = "#variables.COM_FILE_PATH#storage/">
<cfset variables.BEAN_STORAGE_FILE_PATH = "#variables.STORAGE_PATH#bean_storage.xml" />
<cfset variables.EMPTY_STORAGE_FILE_PATH = "#variables.STORAGE_PATH#empty_storage.xml" />
<cfset variables.SHARED_STORAGE_FILE_PATH = "#variables.STORAGE_PATH#shared_storage.xml" />
<cfset variables.COMPONENT_PATH = "com.figleaf.objectstore" />
...
<!--- getBeanDefinitions --->
<cffunction name="getBeanDefinitions" returntype="string" access="public" output="false"
    displayname="Get Avaiable Beans" hint="I return a list of the avaiable beans defined in the configuration XML. NOTE: Use the getBean() method to get a bean to work with. These are only for introspection for programtice instanciation of beans by a developer, not beans to be stored in ObjectStore."
    description="I return list of the avaiable beans defined in the configuration XML.  NOTE: Use the getBean() method to get a bean to work with. These are only for introspection for programtice instanciation of beans by a developer, not beans to be stored in ObjectStore.">
    
	<cfargument name="list" type="boolean" default="false" 
		hint="Should I return a comma delimated list of bean names? I default to ""false""." />
