...
<cffunction name="load" returntype="void" access="public" output="false" 
	hint="I load and parse the XML file.">
...
<!--- loadXML --->
<cffunction name="loadXML" returntype="void" access="public" output="false" 
	hint="I load and parse a XML string or object.">
...
<!--- loadDefinitions --->
<cffunction name="loadDefinitions" returntype="void" access="private" output="false" 
	hint="I load and parse a XML string or object.">
