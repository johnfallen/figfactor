...
<cffunction name="standardRender" access="public" output="true">
	<cfargument name="type" required="true" type="string" default="Render Handler Type" 
		hint="I am the call back to the CommonSpot Standard Rendering.<br />I am requied.">
