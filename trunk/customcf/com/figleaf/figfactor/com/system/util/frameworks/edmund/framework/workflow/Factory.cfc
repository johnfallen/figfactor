...
<!--- decision --->
<cffunction name="decision" returntype="any" access="public" output="false" 
	hint="I return a decision workflow object.">
...
<!--- foreach --->
<cffunction name="foreach" returntype="any" access="public" output="false" 
	hint="I return a foreach loop workflow object.">
...
<!--- loop --->
<cffunction name="loop" returntype="any" access="public" output="false" 
	hint="I return a conditional loop workflow object.">
...
<!--- noop --->
<cffunction name="noop" returntype="any" access="public" output="false" 
	hint="I return a no-op workflow object.">
...
<!--- seq --->
<cffunction name="seq" returntype="any" access="public" output="false" 
	hint="I return a sequence workflow object.">
