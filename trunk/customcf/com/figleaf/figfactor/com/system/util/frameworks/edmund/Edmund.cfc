...
<cffunction name="init" returntype="any" access="public" output="false" 
	hint="I am the framework constructor.">
	...
	<cfset variables.handler = 
		createObject("component","edmund.framework.EventHandler").init(this,arguments.ignoreAsync,variables.logger) />
...
<cffunction name="getWorkflow" returntype="any" access="public" output="false" 
	hint="I return the workflow factory.">
...
<cffunction name="newChild" returntype="any" access="public" output="false" 
	hint="I return a new child event context.">
...
<!--- newParent --->
<cffunction name="newParent" returntype="any" access="public" output="false" 
	hint="I return a new parent event context.">
