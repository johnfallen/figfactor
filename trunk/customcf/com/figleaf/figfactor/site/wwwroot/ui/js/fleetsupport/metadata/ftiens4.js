...
{ 
 ...
 // var fullLink = "href=\""+this.link+"\" target=\""+this.target+"\" onClick=\"clickOnLink('"+this.getID()+"\', '"+this.link+"','"+this.target+"');return false;\"";
  var fullLink = "href=\""+this.link+"\" onClick=\"clickOnLink('"+this.getID()+"\', '"+this.link+"','"+this.target+"');return false;\"";
...
// modified for use in metadata module 
function clickOnLink(clickedId, target, windowName) {  
    highlightObjLink(findObj(clickedId));
   // alert(clickedId);
	thisobj = document.all["BOX" + clickedId];
	if (thisobj.checked) {
		thisobj.checked = false;
	} else {
		thisobj.checked = true;
	}
	fnCheckbox(thisobj,clickedId);
	//if (isLinked(target)) {
