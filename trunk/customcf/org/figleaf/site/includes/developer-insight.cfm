...
<table cellpadding="10">
	<tr valign="top">
		<td>
			...
			<em>Application.BeanFactory.getBean("cache").viewCache()</em>
			</h3>
			<cfdump var="#Application.BeanFactory.getBean('cache').viewCache()#" label="The Configured Cache" expand="true" /></td>
		<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		<td>
