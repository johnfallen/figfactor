...
<cfset siteRoot = config.getWebSiteServerContext() />
<cfset siteContext = config.getWebSiteContext() />
...
<cfinvoke component="#cffm#" method="init">
	...
	<cfinvokeargument name="includeDir" value="#siteRoot#">
	<!--- includeDirWeb = web path to the directory specified above. --->
	<cfinvokeargument name="includeDirWeb" value="#siteContext#">
	...
	// images or something.
	--->
	<cfinvokeargument name="allowedExtensions" value="cfm,cfc,jpg,gif,png,txt,html,htm">
	<!--- editableExtensions:  specifies what kind of files can be edited with the simple text editor --->
	<cfinvokeargument name="editableExtensions" value="properties,cfm,cfml,cfc,dbm,dbml,php,php3,php4,asp,aspx,pl,plx,pls,cgi,jsp,txt,html,htm,log,csv,js,css">
	<!---
	// overwriteDefault = 
...
<cfoutput><a href="../index.cfm"><strong>&laquo;&laquo; Back to Configuration Home</strong></a></cfoutput>
<cfoutput>
