...
<cfcomponent displayname="Controller" extends="ModelGlue.unity.controller.Controller" output="false">
	...
	<!--- Inject the DominAPI intto the variables scope from ColdSpring --->
	<cffunction name="setDomainAPI" hint="I am the DomainAPI.cfc being injected by ColdSpring." >
		<cfargument name="DomainAPI"/>
		<cfset variables.DomainAPI = arguments.DomainAPI />
	</cffunction>
