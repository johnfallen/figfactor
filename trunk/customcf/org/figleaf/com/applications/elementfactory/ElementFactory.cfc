...
<cffunction name="init" returntype="ElementFactory" access="public" output="false" 
	...
	<cfargument name="BeanFactory" required="true" type="any" hint="I am the system beanFactory.<br />I am required." />

	<cfset variables.BeanFactory = arguments.BeanFactory />
	<cfset variables.logger = variables.BeanFactory.getBean("logger") />
	<cfset variables.DATANOTFOUND = variables.BeanFactory.getBean("ConfigBean").getConstants().DATANOTFOUND />

	<!--- internal --->
	<cfset variables.instance = structNew() />
	<cfset variables.instance.elementCollection = variables.BeanFactory.getBean("MapCollection") />
