...
<!--- init --->
<cffunction name="init" access="public" returntype="FileWriter" output="No" 
	hint="initializes the FileWriter CF/java object">
...
<!--- bufferSizeLimit --->
<cffunction name="bufferSizeLimit" access="private" returntype="numeric" output="No" 
	hint="limit the buffer between 8k and 128k. Come on, let's be reasonable.">
	
	<cfargument name="bufferSize" type="numeric" required="no" default="8192"
		 hint="the buffer size for the bufferedWriter" />
...
<!--- getFileEncoding --->
<cffunction name="getFileEncoding" access="private" returntype="void" output="No" 
	hint="checks for a valid file encoding">
...
<!--- writeLine --->
<cffunction name="writeLine" access="public" returntype="void" output="No" 
	hint="writes a string to a file, and places and EOL character at the end">
...
<!--- newLine --->
<cffunction name="newLine" access="public" returntype="void" output="No" 
	hint="Uses the platform's own notion of line separator. Not all platforms use the newline character ('\n') to terminate lines.">
...
<!--- close --->
<cffunction name="close" access="public" returntype="void" output="No" 
	hint="flushes and closes stream, buffer, and file">
