...
------------------------------------------------------------------------------->
<cfcomponent displayname="Simple Timed Cache" output="false" 
...
<cffunction name="put" access="public" hint="Puts content into the cache.">
	...
	<cfargument name="Value" type="any" hint="The content to cache." />
	<cfargument name="timeout" type="numeric" hint="Seconds this item should live in the cache." default="#variables.cacheTimeSpan#" />
...
<!--- get --->
<cffunction name="get" access="public" returntype="any" hint="Gets content from the cache.">
...
<!--- reap --->
<cffunction name="reap" access="public" returntype="void" hint="Instructs implementation to reap stale items.">
...
<!--- viewCache --->
<cffunction name="viewCache" access="public" returntype="struct" hint="Gets information about cache contents.">
