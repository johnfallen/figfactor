...
<cfset theFilePath = application.figFactor.getBean("Config").getWebRootPath() />
<cfset theRealitivePath = application.figFactor.getBean("Config").getWebSiteContext() />
<!--- ************** ADDED by John Allen **************  --->
...
<cfinvoke component="#cffm#" method="init">
	...
	<cfinvokeargument name="includeDir" value="#theFilePath#">
	<!--- includeDirWeb = web path to the directory specified above. --->
	<cfinvokeargument name="includeDirWeb" value="#theRealitivePath#">
	
	<!--- disallowedExtensions = file extensions you don't want people to upload --->
	<cfinvokeargument name="disallowedExtensions" value="dbm,dbml,php,php3,php4,php5,asp,aspx,pl,plx,pls,cgi,jsp,pif,scr,vbs,exe">
	<!---
	// allowedExtensions = 
	...
	// images or something.
	--->
	<cfinvokeargument name="allowedExtensions" value="jpg,gif,png,txt,html,htm,cfm,cfc,ini,xml,head,properties">
	<!--- editableExtensions:  specifies what kind of files can be edited with the simple text editor --->
	<cfinvokeargument name="editableExtensions" value="cfm,cfml,cfc,xml,ini,properties,dbm,dbml,php,php3,php4,asp,aspx,pl,plx,pls,cgi,jsp,txt,html,htm,log,csv,js,css">
	<!---
	// overwriteDefault = 
...
<cfelse>
	<cfoutput><HTML><HEAD><TITLE>CFFM File Manager version #cffm.version#</TITLE></HEAD><BODY></cfoutput>
	<cfhtmlhead text="<link rel=stylesheet type=text/css href=#figPath#cffmDefault.css>">
</cfif>
...
<a href="#cffm.cffmFilename#?subdir=#urlEncodedFormat(subdir)#&action=uploadForm">#cffm.resourceKit.Msg.t25#</a></cfif>
...
<fieldset>
<legend>#cffm.resourceKit.Msg.t26# </legend>
...
<td width="100%">
	<a href="#variables.linkToFile#" target="_self">#cffm.resourceKit.Msg.t31#</a>
</td>
<td>&nbsp;</td>
<td>&nbsp;</td>
<td>&nbsp;</td>
...
<cfloop query="variables.sortedDirList">
<cfsilent>
<cfset cnt = cnt + 1>
...
<cfelse>
	<a href="#cffm.cffmFilename#?subdir=#variables.subdir#&showTotalUsage=1">#cffm.resourceKit.Msg.t45#</a>
</cfif></cfif>
