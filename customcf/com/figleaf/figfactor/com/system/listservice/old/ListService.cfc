...
<cfcomponent displayname="List Service" output="false"
	hint="I read and manage lists used throught out the CommonSpot application and FigFactor supporting applications.">
...
<cffunction name="init" returntype="ListService" access="public" output="false" 
	...
	<cfset variables.UDFLibrary = arguments.udf />
