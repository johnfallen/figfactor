...
<cffunction name="userLogin" returntype="boolean" access="public" output="false"
	...
	<cfif passUsername eq true and passPassword eq true>
		...
		<cfreturn 1 />
	<cfelse>
		<cfset variables.logger.setMessage(message = "Failed Login Attempt: #arguments.username#") />
		<cfreturn 0 />
	</cfif>
</cffunction>
...
<entry>
	...
	<dateCreated>#dateFormat(now(), "long")# | #timeFormat(Now(), "long")#</dateCreated>
</entry>
</cfoutput>
</cfxml>
...
<cffunction name="setInternalLookUp" returntype="void" access="public" output="false"
	...
	<cfloop array="#xml.access.XmlChildren#" index="x">
		...
		<cftry>
		<cfset entry.dateCreated = x.XmlChildren[3].XmlText />
		<cfcatch></cfcatch>
		</cftry>
