...
<cffunction name="init" returntype="BeanService" access="public" output="false" 
	...
	<!--- a map of all my managed beans, used for documentation of this instance --->
...
<cffunction name="getBean" returntype="component" access="public" output="false"
	...
	<cfset setDocumentationBean(bean.getBeanName(), duplicate(bean)) />
...
<!--- *********** Package *********** --->
<!--- *********** Private *********** --->
<!--- setDocumentationBean --->
<cffunction name="setDocumentationBean" returntype="void" access="public" output="false"
    displayname="Set Documentation Bean" hint="I set a bean to my internal map of beans."
...
<cffunction name="getAllBeans" returntype="struct" access="public" output="false"
    displayname="Get All Beans" hint="I return all of my insanciated beans I manage."
    description="I return all of my insanciated beans I manage.">
