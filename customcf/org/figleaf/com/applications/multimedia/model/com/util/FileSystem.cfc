...
<cffunction name="CreateFile" access="public" output="false" returntype="any">
	...
	<cftry>
		...
		<cfcatch type="any">
			<cfthrow type="FileSystem.CreateFile" message="The file #fileName# was not created." detail="#cfcatch.message#">
		</cfcatch>
	</cftry>
</cffunction>
...
<cffunction name="listDirectory" returntype="any" access="public" output="false"
	...
	<cfargument name="Destination" required="true" type="string" 
		hint="I am the fully system path to the directory.<br />I am required." />
...
<cffunction name="upload" access="public" output="false" returntype="any">
	...
	<cfargument name="formFieldName" required="true" type="string" 
		hint="I am the form field name containing the file.<br />I am required." />
	<cfargument name="NewFileName" type="string" 
		hint="I am the string to change the file name too.<br />I default to an empty string." />
	...
	<cftry>
		...
		<cfcatch type="any">
			<cfthrow type="fileSystem.upload" />
		</cfcatch>
	</cftry>
...
<cffunction name="read" access="public" output="false" returntype="any">
	...
	<cftry>
		...
		<cfcatch type="any">
			<cfthrow type="FileSystem.read" message="#cfcatch.message#" detail="#cfcatch.detail#" />
		</cfcatch>
	</cftry>
