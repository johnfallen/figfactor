...
==================================================================================
--->
<cfcomponent name="softcache" output="false" displayname="Soft Cache" 
...
<cffunction name="get" output="false" 
	description="Returns the value for the specified key, or the string specified by variables.notfound if unavailable.">
	<cfargument name="key" />
...
<!--- put --->
<cffunction name="put" output="false" description="Puts a key/value pair into the cache.">
	<cfargument name="key" />
...
<!--- delete --->
<cffunction name="delete" output="false" description="Deletes a key/value pair from the cache.">
	<cfargument name="key" />
