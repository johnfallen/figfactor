...
<cffunction name="dump" returntype="void" 
	hint="I provide cfdump/cfabort functionality within cfscript blocks." output="false">
	
	<cfargument name="VariabletoDump" required="true" type="any" 
		hint="The variable to dump to the screen.">
...
<!--- first --->
<cffunction name="first" returntype="void" access="public" output="false" 
	hint="I set the iterator to point to the first record so it is ready to access with the first record.">
...
<!--- invalidAccess --->
<cffunction name="invalidAccess" returntype="void" output="false" 
	hint="This method is called if you try to get or set an instance or class property that is not gettable/settable or doesn't exist. By default it throws an error.">

	<cfargument name="MethodName" required="true" type="string" 
		hint="The name of the method having problem with access - get(), set(), classGet() or classSet().">
	<cfargument name="PropertyName" required="true" type="string" 
		hint="The name of the property the method was unable to access.">
	<cfargument name="Problem" required="true" type="string" 
		hint="The problem that the method had accessing the property.">
